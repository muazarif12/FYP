...
def merge_extractive_summaries(
    ...
    """
    Fixed version that avoids parallel tensor loading issues
    """
    print("Using FIXED merge_extractive_summaries to avoid tensor conflicts...")
    
    # Run summary generation SEQUENTIALLY instead of in parallel to avoid tensor conflicts
    print("Running standard extractive summary...")
    summary1 = generate_extractive_summary(
    ...
    print("Running sentiment-based extractive summary...")
    summary2 = generate_extractive_summary_sentiments(
        model_name=model_name,
        sentence_list=sentence_list,
        language=language,
        summary_ratio=summary_ratio,
    ...
    print(f"Merged summary complete: {len(merged_summary)} segments")
